...
use Modules\Order\Emails\NewOrderMail;
...
//    }
    ...
    public function success(Request $request)
    {
        ...
        if ($orderDetails) {
            $orderDetails->allProducts = $orderDetails->orderProducts->mergeRecursive($orderDetails->orderVariations);
            if ($orderDetails->orderAddress) {
                $this->sendEmailNotify($orderDetails, $orderDetails->orderAddress->email);
            }
        }
