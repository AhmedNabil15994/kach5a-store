            ...
            @if (Module::isEnabled('Company'))
                ...
                <li class="nav-item  {{active_slide_menu(['companies','delivery-charges','drivers'])}}">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item {{ active_menu('delivery_times') }}">
                            <a href="{{ url(route('dashboard.delivery_times.index')) }}" class="nav-link nav-toggle">
                                <i class="icon-settings"></i>
                                <span class="title">{{ __('apps::dashboard.aside.delivery_times') }}</span>
                                <span class="selected"></span>
                            </a>
                        </li>
                    </ul>
