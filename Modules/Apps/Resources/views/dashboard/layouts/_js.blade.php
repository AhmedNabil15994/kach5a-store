...
console.log(data)
    ...
    {{--function playSound() {--}}
    {{--    var audio = new Audio('{{ url('uploads/media/blackberry_sms.mp3') }}');--}}
    {{--    audio.play();--}}
    {{--}--}}
    ...
    const playSound = (audioURL, playCount = 1) => {
        ...
        /** N.B. This line:
         ...
         audioClip.addEventListener('loadedmetadata', () => console.log(audioClip.duration));

         tells us that the sound file duration is 2.142 seconds **/

        const audioClipDuration = 31142;
        audioClip.loop = true;
    ...
    function openActivity(response) {
        playSound('{{ url('uploads/media/blackberry_sms.mp3') }}', 2);
        // playSound()
        // Show
