                             ...
                             <div class="row invoice-head contentPrint">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        {{ __('order::dashboard.orders.show.delivery_time.type') }} : {{ __('order::dashboard.orders.show.delivery_time.' . $order->shipping_type)}}
                                        @endif
                                    </div>
                                    @if($order->shipping_type == 'schedule')
                                    ...
                                    @if (!empty($order->shipping_time_from))
                                        <div class="col-md-6 col-xs-12">
                                            <div style="margin: 10px;">
                                                <b>{{ __('order::dashboard.orders.show.delivery_time.time') }}
                                                    : </b>
                                                <span>{{ __('order::dashboard.orders.show.delivery_time.From') }}:
                                                    {{ $order->shipping_time_from ?? '---' }}</span>
                                                <span>{{ __('order::dashboard.orders.show.delivery_time.To') }}: {{ $order->shipping_time_to ?? '---' }}</span>
                                            </div>
                                        </div>
                                    @endif
                                    @endif
