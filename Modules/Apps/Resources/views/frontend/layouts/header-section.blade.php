            ...
            <div class="container">
                <div class="topp">
                    ...
                    <ul class="header-top-right">
                        ...
                        @endphp
                        <li class="menu-item-has-children select_currency">
                            <a href="#" class="currency_selector" data-toggle="modal" data-target="#currenciesModal" data-backdrop="static" data-keyboard="false">
{{--                                <i class="fa fa-dollar"></i>--}}
                                @if($current_country)
                                <span>{{ $current_country->title }}</span>
                                @else
